  ...
  initializePermissionConfig() {
    this.permissionConfig = {
      ...
      sales: [
        ...
        { id: 8, slug: 'sales-return-request', url: '/sales/return-orders', permission: this.hasPermission('sales-return-request') ? true : false },
        { id: 9, slug: 'credit-note-tab', url: '/sales/credit-notes', permission: this.hasPermission('credit-note-tab') ? true : false },
        { id: 10, slug: 'sales-quotation-request', url: '/sales/quotation-requests', permission: this.hasPermission('sales-quotation-request') ? true : false }],
      customer: [
      ...
      settingsSite: [
        { id: 1, slug: 'settings-site-seo', url: '/settings/sitesettings/seo', permission: this.hasPermission('settings-site-seo') ? true : false },
        { id: 2, slug: 'settings-site-social', url: '/settings/sitesettings/social', permission: this.hasPermission('settings-site-social') ? true : false },
        { id: 3, slug: 'settings-site-filter', url: '/settings/sitesettings/filter', permission: this.hasPermission('settings-site-filter') ? true : false },
        { id: 4, slug: 'settings-site-variant', url: '/settings/sitesettings/variants', permission: this.hasPermission('settings-site-variant') ? true : false },
        { id: 5, slug: 'settings-site-attribute', url: '/settings/sitesettings/attributes', permission: this.hasPermission('settings-site-attribute') ? true : false },
        { id: 6, slug: 'settings-site-attribute-groups', url: '/settings/sitesettings/attributes-group', permission: this.hasPermission('settings-site-attribute-groups') ? true : false },
      ],
      settingsLocal: [
        ...
        { id: 9, slug: 'list-email-template', url: '/settings/local/emailtemp', permission: this.hasPermission('list-email-template') ? true : false },
      ]
    };
  }
      ...
      this.http
        ...
        .subscribe(
          response => {
            ...
            if (
              (permissionKeys.indexOf('sales-return-request') > -1 &&
                permissions['sales-return-request'])
            ) {
              permissions['sales-return-request'] = true;
              permissions['sales'] = true;
            }

            
            if (
              (permissionKeys.indexOf('credit-note-tab') > -1 &&
                permissions['credit-note-tab'])
            ) {
              permissions['credit-note-tab'] = true;
              permissions['sales'] = true;
            }
