...
export class GeneralsettingetResponseModel {
  ...
  constructor(generalsettingresponse: any) {
    ...
    this.registeredAddress = generalsettingresponse.registeredAddress || '';
    this.cinNumber = generalsettingresponse.cinNumber || '';
    this.gstinNumber = generalsettingresponse.gstinNumber || '';
