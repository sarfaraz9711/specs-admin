...
export const couponBulkDelete = createSelector(
  getCatState,
  fromCoupon.couponBulkDelete
);
export const bulkDeleteLoading = createSelector(
  getCatState,
  fromCoupon.bulkDeleteLoading
);
export const bulkDeleteLoaded = createSelector(
  getCatState,
  fromCoupon.bulkDeleteLoaded
);
export const bulkDeleteFailed = createSelector(
  getCatState,
  fromCoupon.bulkDeleteFailed
);
