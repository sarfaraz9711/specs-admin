...
export const ActionTypes = {
  ...
  CLEAR_STATE_VARIABLE: type('[List] Clear State variable'),

  EXPORT_COUPON_ACTION: type('[export] EXPORT_COUPON_ACTION'),
  EXPORT_COUPON_SUCCESS: type('[export] EXPORT_COUPON_SUCCESS'),
  EXPORT_COUPON_FAIL: type('[export] EXPORT_COUPON_FAIL'),


  EXPORT_ALL_COUPON_ACTION: type('[exportall] EXPORT_ALL_COUPON_ACTION'),
  EXPORT_ALL_COUPON_SUCCESS: type('[exportall] EXPORT_ALL_COUPON_SUCCESS'),
  EXPORT_ALL_COUPON_FAIL: type('[exportall] EXPORT_ALL_COUPON_FAIL'),

//Bulk Delete

  DO_COUPON_BULK_DELETE: type('[COUPON BULK DELETE] DO Coupon Bulk Delete'),
  DO_COUPON_BULK_DELETE_SUCCESS: type('[COUPON BULK DELETE SUCCESS] Do Coupon Bulk Delete Success'),
  DO_COUPON_BULK_DELETE_FAIL: type('[COUPON BULK DELETE] Do Coupon Bulk Delete Fail'),
...
export class ClearStateVariableAction implements Action {
  type = ActionTypes.CLEAR_STATE_VARIABLE;
  constructor(public payload: any = null) {}
}

export class ExportCouponAction implements Action {
  type = ActionTypes.EXPORT_COUPON_ACTION;
  constructor(public payload: any) {
  }
}

export class ExportCouponSuccess implements Action {
  type = ActionTypes.EXPORT_COUPON_SUCCESS;
  constructor(public payload: any) {
  }
}

export class ExportCouponFail implements Action {
  type = ActionTypes.EXPORT_COUPON_FAIL;
  constructor(public payload: any = null) {

  }
}

export class ExportAllCouponAction implements Action {
  type = ActionTypes.EXPORT_ALL_COUPON_ACTION;
  constructor(public payload: any) {
  }
}

export class ExportAllCouponSuccess implements Action {
  type = ActionTypes.EXPORT_ALL_COUPON_SUCCESS;
  constructor(public payload: any) {
  }
}

export class ExportAllCouponFail implements Action {
  type = ActionTypes.EXPORT_ALL_COUPON_FAIL;
  constructor(public payload: any = null) {
...
//Bulk delete
export class DoCouponBulkDelete implements Action {
  type = ActionTypes.DO_COUPON_BULK_DELETE;

  constructor(public payload: any = null) { 
  }
}

export class DoCouponBulkDeleteSuccess implements Action {
  type = ActionTypes.DO_COUPON_BULK_DELETE_SUCCESS;

  constructor(public payload: any) { }
}

export class DoCouponBulkDeleteFail implements Action {
  type = ActionTypes.DO_COUPON_BULK_DELETE_FAIL;
...
export type Actions =
  ...
  | DoCouponBulkDelete
  | DoCouponBulkDeleteSuccess
  | DoCouponBulkDeleteFail;
