...
export class ProductAddResponseModel {
  ...
  public filterAnkleValue:string
  ...
  constructor(productaddResponse: any) {
    ...
    this.filterAnkleValue =productaddResponse.filterAnkleValue || ''
    this.productSellingPrice =productaddResponse.productSellingPrice || ''
  }
}
