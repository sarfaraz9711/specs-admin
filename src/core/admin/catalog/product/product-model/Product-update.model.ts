...
export class ProductUpdateModel {
  ...
  public productaddResponse:string
  public productSellingPrice:any
  ...
  constructor(ProdupdateForm: any) {
    ...
    this.productaddResponse = ProdupdateForm.productaddResponse || ''
    this.productSellingPrice = ProdupdateForm.productSellingPrice || ''
    this.productSizeColor = ProdupdateForm.productSizeColor || ''
    this.inventorySync = ProdupdateForm.inventorySync || 0
  }
}
