...
export class ProductAddModel {
  ...
  constructor(fromProductAdd: any) {
    ...
    this.filterAnkleValue = fromProductAdd.filterAnkleValue
    this.productVarientOption = fromProductAdd.productVarientOption;
    this.productSizeColor = fromProductAdd.productSizeColor;
    this.productVarient = fromProductAdd.productVarient;
    this.productVideo = fromProductAdd.productVideo || {};
    this.productSellingPrice = fromProductAdd.productSellingPrice || {}
    this.inventorySync = fromProductAdd.inventorySync || 0;
