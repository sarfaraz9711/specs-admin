...
// <-------------GET RATING REVIEW LIST--------------> //
    ...
    case actions.ActionTypes.GET_RATING_REVIEW_LIST_SUCCESS: {
      const ratingReviewModel = payload.data.map(_products => {
        ...
        // tempProductModel.reviewImages = ["https://cdn.redchief.in/0/images/product/665//rc3500-001-1-a-481-z-665.jpg",
        //  "https://cdn.redchief.in/0/images/product/665//rc3500-001-3-a-481-z-665.jpg",
        //  "https://cdn.redchief.in/0/images/product/665//rc3500-001-7-a-481-z-665.jpg"
        // ]
