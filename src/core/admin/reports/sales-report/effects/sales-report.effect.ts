...
export class SalesReportEffect {
  ...
  @Effect()
  salesReportList$: Observable<Action> = this.action$.pipe(
  ...
  // <---------------SALES REPORT LIST COUNT------------------> //
   ...
   @Effect()
   salesReportListCount$: Observable<Action> = this.action$.pipe(
...
// <---------------EXPORT ALL SALES REPORT LIST COUNT------------------> //
    ...
    @Effect()
    exportAllSalesReport$: Observable<Action> = this.action$.pipe(
