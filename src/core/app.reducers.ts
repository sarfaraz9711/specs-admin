...
import * as fromContactUs from './admin/PublicForms/layout/reducer/layout.reducer';
...
import * as fromFeedback from './admin/PublicForms/feedback/feedback-reducer/feedback-reducer'
...
export const reducers: any = {
  ...
  contactUsLayout: fromContactUs.reducer,
