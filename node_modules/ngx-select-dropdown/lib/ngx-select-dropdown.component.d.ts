...
export declare class NgxSelectDropdownComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgxSelectDropdownComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NgxSelectDropdownComponent, "ngx-select-dropdown", never, { "options": "options"; "config": "config"; "multiple": "multiple"; "_value": "_value"; "disabled": "disabled"; }, { "change": "change"; "searchChange": "searchChange"; "open": "open"; "close": "close"; }, never, never>;
}

//# sourceMappingURL=ngx-select-dropdown.component.d.ts.map